...
error_log("Starting index.php"); // Log start
...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo $base_url; ?>/assets/images/banners/animation1.jpg" class="d-block w-100" alt="Image 1">
        ...
        <div class="carousel-item">
            <img src="<?php echo $base_url; ?>/assets/images/banners/animation2.jpg" class="d-block w-100" alt="Image 2">
            <div class="carousel-content">
                <h1>Pleated Perfection</h1>
                <p>NEW 52" sweep pleated blades + 12" light kit for TriAire™</p>
                <a href="#" class="btn">Learn More</a>
        ...
        <div class="carousel-item">
            <img src="<?php echo $base_url; ?>/assets/images/banners/animation3.jpg" class="d-block w-100" alt="Image 3">
            <div class="carousel-content">
                <h1>Pleated Perfection</h1>
                <p>NEW 52" sweep pleated blades + 12" light kit for TriAire™</p>
                <a href="#" class="btn">Learn More</a>
...
<div class="content-1">
    ...
    <div class="content1-fan-img">
        <img src="<?php echo $base_url; ?>/assets/images/banners/home_image_3.png" alt="">
    </div>
    <div class="intro-content-1">
        ...
        <div class="content1-banner">
            <img src="<?php echo $base_url; ?>/assets/images/banners/content-1-img.png" alt="">
        </div>
    </div>
    <div class="featured-products">
        ...
        <div class="products-grid">
            <?php
            global $conn;
            $stmt = $conn->prepare("SELECT p.id, p.name, p.price, p.slug, pi.image_url 
                                    FROM products p 
            ...
            if ($stmt) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="product-card">
                        <img src="<?php echo htmlspecialchars($row['image_url'] ?? ($base_url . '/assets/images/default.jpg')); ?>" alt="<?php echo htmlspecialchars($row['name']); ?>" class="product-image">
                ...
                error_log("Query error in index.php: " . $conn->error);
